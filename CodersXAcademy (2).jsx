...
const MENTORS = [
  { name: "Rituraj Singh Gour", company: "Adobe, Amazon", linkedin: "https://www.linkedin.com/in/rituraj-singh-gour-bb7721171/" },
  { name: "Varun Tyagi", company: "Booking.com (Europe)", linkedin: "https://www.linkedin.com/in/varuntyagi-3112/" },
  { name: "Nishant Sharma", company: "Industry Mentor", linkedin: "https://www.linkedin.com/in/nishant-sharma05/" },
  { name: "Mohit Ranawat", company: "Target, Visa", linkedin: "https://www.linkedin.com/in/mohitranawat/" },
  { name: "Sukrati Pateriya", company: "Amazon", linkedin: "https://www.linkedin.com/in/sukrati7/" },
  { name: "Sanskar Rastogi", company: "PayPal", linkedin: "https://www.linkedin.com/in/sanskar-rastogi/" },
  { name: "Abhishek Kaundal", company: "PayPal", linkedin: "https://www.linkedin.com/in/abhishek-kaundal-209b58129/" },
  { name: "Mradul Saraf", company: "Industry Mentor", linkedin: "https://www.linkedin.com/in/mradul-saraf-97414781/" },
];

const TESTIMONIALS = [
  { name: "Aditya Dwivedi", org: "Tata Consultancy Services", linkedin: "https://www.linkedin.com/in/aditya-dwivedi-19355b151" },
  { name: "Muskan Singhal", org: "Deloitte", linkedin: "https://www.linkedin.com/in/muskan-singhal-29267a190" },
  { name: "Priyanka Bind", org: "Capgemini", linkedin: "https://www.linkedin.com/in/priyanka-bind-13a732186" },
  { name: "Saketh Reddy Sheri", org: "EY", linkedin: "https://www.linkedin.com/in/saketh-reddy-sheri-92b357137" },
  { name: "Sarthak Bhatt", org: "Accenture", linkedin: "https://www.linkedin.com/in/sarthak-bhatt-a750431a2" },
  { name: "Isha Agarwal", org: "Bank of America (BOA)", linkedin: "https://www.linkedin.com/in/isha-agrawal-141ba21b5" },
];

const COMPANIES = ["Google", "Amazon", "Microsoft", "TCS", "Infosys", "Deloitte", "Accenture"];
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
        <a href="#home" className="flex items-center gap-2 font-[Poppins] font-bold text-lg text-slate-900">
          <span className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#2563EB] to-[#38BDF8] flex items-center justify-center text-white text-sm">
            {"</>"}
          </span>
          CodersX <span className="text-[#2563EB]">Academy</span>
        </a>
        ...
        <Reveal delay={150}>
          <div className="relative h-[420px] hidden sm:block">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-72 h-72 rounded-3xl bg-gradient-to-br from-[#2563EB] to-[#38BDF8] rotate-6 shadow-2xl shadow-blue-500/30" />
            </div>
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-7 sm:p-8">
        ...
        {done ? (
          <div className="text-center py-6">
            ...
            <h3 className="font-[Poppins] font-bold text-xl text-slate-900">
              Thank You for Downloading the Syllabus.
            </h3>
            <p className="text-sm text-slate-500 mt-2">Check your downloads folder for the PDF.</p>
          </div>
        ) : (
          <>
            ...
            {step === 1 ? (
              <>
                ...
                <div className="space-y-4">
                  <div>
                    <Field icon={User} placeholder="Name" value={form.name} onChange={update("name")} />
                    {errors.name && <p className="text-xs text-red-500 mt-1">{errors.name}</p>}
                  </div>
                  <div>
                    <Field icon={Phone} placeholder="Mobile Number" value={form.mobile} onChange={update("mobile")} />
                ...
                <RippleButton variant="primary" className="w-full mt-6 py-3.5" onClick={handleNext}>
                  Continue <ArrowRight className="w-4 h-4" />
                </RippleButton>
              </>
            ) : (
              <>
                <h3 className="font-[Poppins] font-bold text-xl text-slate-900 mb-1">Select Course</h3>
                <p className="text-sm text-slate-500 mb-6">Step 2 of 2 — Almost there</p>
                <Select icon={Code2} value={form.course} onChange={update("course")}>
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <RippleButton variant="primary" className="flex-1 py-3.5" onClick={handleFinish}>
  ...
  return (
    <section id="mentors" className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <Reveal>
          <div className="flex items-end justify-between gap-4 mb-10">
            ...
            <div className="hidden sm:flex gap-2">
              <button onClick={() => scroll(-1)} className="w-10 h-10 rounded-full border border-slate-200 bg-white flex items-center justify-center hover:border-[#2563EB] hover:text-[#2563EB] transition">
        ...
        <div ref={scrollerRef} className="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scroll-smooth [scrollbar-width:none]">
          {MENTORS.map((m, i) => (
            <div key={m.name} className="snap-start shrink-0 w-64 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-1.5 transition-all duration-300 p-6 text-center">
              <div className="w-20 h-20 rounded-full mx-auto bg-gradient-to-br from-[#2563EB] to-[#38BDF8] flex items-center justify-center text-white font-[Poppins] font-bold text-xl">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t, i) => (
            <Reveal key={t.name} delay={i * 100}>
              <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-7 h-full flex flex-col">
                <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[#2563EB] to-[#38BDF8] flex items-center justify-center text-white font-[Poppins] font-bold text-sm mb-5">
                ...
                <p className="text-sm text-slate-600 flex-1">
                  Successfully placed at <span className="font-semibold text-slate-800">{t.org}</span> through CodersX Academy's placement program.
                </p>
                <div className="mt-5 pt-5 border-t border-slate-100 flex items-center justify-between">
                  <div>
                    <p className="font-[Poppins] font-semibold text-sm text-slate-900">{t.name}</p>
                    <p className="text-xs text-[#2563EB] font-medium">{t.org}</p>
                  </div>
                  <a
                    href={t.linkedin}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-slate-500 hover:border-[#2563EB] hover:text-[#2563EB] transition shrink-0"
                  >
        ...
        <Reveal delay={200}>
          <div className="mt-16 flex flex-wrap items-center justify-center gap-x-10 gap-y-6">
            {COMPANIES.map((c) => (
              <span key={c} className="text-slate-400 font-[Poppins] font-semibold text-lg tracking-wide">
                {c}
              </span>
            ))}
          </div>
  ...
  return (
    <footer className="bg-slate-900 text-slate-300 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          <div className="flex items-center gap-2 font-[Poppins] font-bold text-lg text-white">
            <span className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#2563EB] to-[#38BDF8] flex items-center justify-center text-sm">
              {"</>"}
            </span>
            CodersX Academy
          </div>
